...
fim_var_help_db[FIM_VID_RE_SEARCH_OPTS]= "[internal,in] if empty, defaults will apply; if contains 'i' ('I'), case insensitive (sensitive) searches will occur; if contains 'b', will match on basename, if contains 'f' on full pathname. " ;
