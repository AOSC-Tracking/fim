...
fim_var_help_db[FIM_VID_WANT_CAPTION_STATUS]= "[internal,experimental] if not 0, and if supported by the display device, will show the status (or command) line in the window manager caption; if set to a non-empty string, will display that string." ;
