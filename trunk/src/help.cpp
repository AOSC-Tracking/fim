...
fim_var_help_db[FIM_VID_OVERRIDE_DISPLAY]= "[internal,undocumented]" ;
...
fim_var_help_db[FIM_VID_SCALE_FACTOR_MULTIPLIER]= "[internal,undocumented]" ;
fim_var_help_db[FIM_VID_SCALE_FACTOR_DELTA]= "[internal,undocumented]" ;
...
fim_var_help_db[FIM_VID_CONSOLE_LINE_WIDTH]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_CONSOLE_LINE_OFFSET]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_CONSOLE_BUFFER_LINES]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_CONSOLE_BUFFER_TOTAL]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_CONSOLE_BUFFER_FREE]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_CONSOLE_BUFFER_USED]= "[internal,in,undocumented]" ;
...
fim_var_help_db[FIM_VID_VERBOSE_ERRORS]= "[internal,in,undocumented]" ;
...
fim_var_help_db[FIM_VID_ASCALE]= "[internal,in] the asymmetric scaling of the current image" ;
fim_var_help_db[FIM_VID_ANGLE]= "[internal,undocumented]" ;
...
fim_var_help_db[FIM_VID_AUTOFLIP]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_AUTONEGATE]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_FLIPPED]= "[internal,undocumented]" ;
fim_var_help_db[FIM_VID_NEGATED]= "[internal,undocumented]" ;
fim_var_help_db[FIM_VID_FIM_BPP]= "[internal,out] the bits per pixel count" ;
fim_var_help_db[FIM_VID_AUTOMIRROR]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_MIRRORED]= "[internal,undocumented]" ;
fim_var_help_db[FIM_VID_WANT_AUTOCENTER]= "[internal,in,undocumented]" ;
fim_var_help_db[FIM_VID_MAX_CACHED_IMAGES]= "[internal,in] the maximum number of images allowed in the cache" ;
fim_var_help_db[FIM_VID_MAX_CACHED_MEMORY]= "[internal,in] the maximum amount of memory allowed for the cache" ;
