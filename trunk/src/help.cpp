...
fim_var_help_db[FIM_VID_COMMENT_OI]= "[experimental,in,g:] if set not to 0, will display a custom comment string specified according to the value of_caption_over_image_fmt; if larger than 1, with black background. " ;
fim_var_help_db[FIM_VID_COMMENT_OI_FMT]= "[experimental,in,g:] custom info format string, displayed in a caption over the image; if unset: i:_comment; otherwise a custom format string specified just as _info_fmt_str." ;
