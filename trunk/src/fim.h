...
#define FIM_VID_SEEK_MAGIC			"_seek_magic"		/* "[optional,g:] will seek a 'magic' signature in the file after opening it, and will try decoding it within the range of that signature (use like this: fim -C '_seek_magic=MAGIC_STRING;push filename' ) " */
...
#define FIM_CMD_HELP_WINDOW FIM_FLT_WINDOW " " FIM_CNS_EX_ARGS_STRING " : this command is disabled. It shall be re-enabled in a future version."
