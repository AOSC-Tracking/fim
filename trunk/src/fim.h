...
#define FIM_VID_WANT_MOUSE_CTRL		"_want_wm_mouse_ctrl"	/* "[in,g:] if set to 1, enable mouse click/movement behaviour when in SDL mode; clicking the middle button will display usage info." */
