...
#define interactive_mode_ 0
	...
	std::map<std::string,std::string> aliases__; // TODO: FIXME: temporary
	std::string aliases_;
...
static void do_init_cmd_funcs(void)
{
	...
	cmd_funcs_["add_new_alias_and_variable"] = [](){ 
		...
		aliases__["new_alias"]="new_alias_value";
...
void do_rebuild_help_menus(void)
{
	...
	aliases_ = cc.get_aliases_list(); // invalidates lots of widgets
	// new stuff
