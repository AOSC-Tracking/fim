...
#define FIM_VID_COMMENT_OI 				"_comment_over_image"				/* "[experimental,in,g:] if _comment_over_image is set not to 0, will display the contents of i:_comment over the image." */
