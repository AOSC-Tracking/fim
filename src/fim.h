...
#define FIM_CMD_HELP_PREFETCH FIM_FLT_PREFETCH ": prefetch (read into the cache) the two nearby image files (next and previous), for a faster subsequent opening." FIM_CNS_CMDSEP "See also the '" FIM_VID_WANT_PREFETCH "' variable."
