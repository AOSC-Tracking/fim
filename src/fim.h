...
#define FIM_VID_SEEK_MAGIC			"_seek_magic"		/* "[optional,g:] will seek for a magic signature before opening a file (for now, use like this: fim -C '_seek_magic=MAGIC_STRING;push filename' ) " */
