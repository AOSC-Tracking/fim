...
fim_var_help_db[FIM_VID_SEEK_MAGIC]= "[optional,g:] will seek a 'magic' signature in the file after opening it, and will try decoding it within the range of that signature (use like this: fim -C '_seek_magic=MAGIC_STRING;push filename' ) " ;
