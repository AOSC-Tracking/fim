...
fim_var_help_db[FIM_VID_WANT_MOUSE_CTRL]= "[in,g:] if set to 1, enable mouse click/movement behaviour when in SDL mode; clicking middle or right button will toggle on-screen usage info." ;
